...
class MyMap():
    ...
    def __init__(self, x, y):
        # 加载背景图片
        self.bg = pygame.image.load("MarieAdventure\image\\bg.png").convert_alpha()
        self.x = x
        self.y = y
...
class Music_Button():
    ...
    def __init__(self):
        self.open_img = pygame.image.load('MarieAdventure/image/btn_open.png').convert_alpha()
        self.close_img = pygame.image.load('MarieAdventure/image/btn_close.png').convert_alpha()
        self.bg_music = pygame.mixer.Sound('MarieAdventure/audio/bg_music.wav')  # 加载背景音乐
    # 判断鼠标是否在，按钮的范围内
    def is_select(self):
        # 获取鼠标，的坐标
...
class Marie():
    def __init__(self):
        ...
        # 加载小玛丽图片
        self.adventure_img = (
            pygame.image.load("MarieAdventure/image/adventure1.png").convert_alpha(),
            pygame.image.load("MarieAdventure/image/adventure2.png").convert_alpha(),
            pygame.image.load("MarieAdventure/image/adventure3.png").convert_alpha(),
        )
        self.jump_audio = pygame.mixer.Sound('MarieAdventure/audio/jump.wav')  # 跳音效
...
class Obstacle():
    ...
    def __init__(self):
        ...
        self.rect = pygame.Rect(0, 0, 0, 0)
        # 加载障碍物图片
        self.missile = pygame.image.load("MarieAdventure/image/missile.png").convert_alpha()
        self.pipe = pygame.image.load("MarieAdventure/image/pipe.png").convert_alpha()
        # 加载分数图片
        self.numbers = (pygame.image.load('MarieAdventure/image/0.png').convert_alpha(),
                        pygame.image.load('MarieAdventure/image/1.png').convert_alpha(),
                        pygame.image.load('MarieAdventure/image/2.png').convert_alpha(),
                        pygame.image.load('MarieAdventure/image/3.png').convert_alpha(),
                        pygame.image.load('MarieAdventure/image/4.png').convert_alpha(),
                        pygame.image.load('MarieAdventure/image/5.png').convert_alpha(),
                        pygame.image.load('MarieAdventure/image/6.png').convert_alpha(),
                        pygame.image.load('MarieAdventure/image/7.png').convert_alpha(),
                        pygame.image.load('MarieAdventure/image/8.png').convert_alpha(),
                        pygame.image.load('MarieAdventure/image/9.png').convert_alpha())
        # 加载加分音效
        self.score_audio = pygame.mixer.Sound('MarieAdventure/audio/score.wav')  # 加分
        # 0和1随机数
...
# 游戏结束的方法
def game_over():
    bump_audio = pygame.mixer.Sound('MarieAdventure/audio/bump.wav')  # 撞击
    bump_audio.play()  # 播放撞击音效
    # 获取窗体宽、高
    screen_w = pygame.display.Info().current_w
    screen_h = pygame.display.Info().current_h
    # 加载游戏结束的图片
    over_img = pygame.image.load('MarieAdventure/image/gameover.png').convert_alpha()
    # 将游戏结束的图片绘制在窗体的中间位置
